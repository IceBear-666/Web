...
window.myresumeCommon = window.myresumeCommon || {
	...
	requestTargets: {
		// 作品的增、改
		workShowSave: '/Resume/workShow',
		// 作品的删
		workShowDel: '/Resume/workDel',

		// 技能增、改
		skillSave: '/Resume/skillSave',
		// 技能删
		skillDel: '/Resume/skillDel',
		// 技能全删
		skillDelAll: '/Resume/skillDelAll',

		// 作品图片
		workUpload: '/Resume/uploadWorkPic',

		// 作品剪切
		workCut: '/workShow/cutWorkPic.json',

		// 项目经验 save、edit
		projectExpSave: 'Resume/projectExperience',

		// 项目经验 del
		projectExpDel: 'Resume/delProject',

		// 期望工作
		expectJobSave: '/Resume/expectJobs',

		// 自我描述
		myRemark: '/Resume/intro',

		//上传公司logo
		uploadLogo: '/Resume/uploadLogo',
	...
	utils: {
		 ...
		 * @use   x.addHttpPrefix('http://|https://', 'www.xxx.com', function(newV){
	              		me.setValue(newV);
	              });
		 */
