...
$(function() {
	...
	$("#search_input").catcomplete({
	  ...
	  if (b==1) {
		  $("#search_input").attr("placeholder", "搜索你感兴趣的职位"), $(".placeholder").val("搜索你感兴趣的职位");
		   $("#searchForm").attr('action','/Jobs/index.html');
		  $("#spc").val(1);
	  }else if(b==2){
		  $("#spc").val(2);
		  $("#searchForm").attr('action','/Company/index.html');
		  $("#search_input").attr("placeholder", "搜索你感兴趣的公司"), $(".placeholder").val("搜索你感兴趣的公司");
	  }else if(b==3){
		  $("#spc").val(3);
		   $("#searchForm").attr('action','/Video/index.html');
		  $("#search_input").attr("placeholder", "搜索你感兴趣公司的宣讲会"), $(".placeholder").val("搜索你感兴趣公司的宣讲会");
	  }
