...
$(function(){
	...
	/*** check rangeLength ***********************/ 
		...
		/*** check 字符长度 区分中英文***********************/ 	
		jQuery.validator.addMethod("rangeLenMin", function(value, element,param) {
		...
		/*** check 字符长度 区分中英文***********************/ 	
		jQuery.validator.addMethod("rangeLenMax", function(value, element,param) {
			var len = value.length;
			if(value.length == 0 ){
				return true;
			}			
	...
	/*** check salary 最大值大于最小值***********************/ 	
		...
		jQuery.validator.addMethod("isTel", function(value, element,param) {
			...
			var isTel = true;
			var pattern=/(^[0-9]{3,4}\-[0-9]{7,8}$)|(^[0-9]{7,8}$)|(^[0-9]{3,4}\-[0-9]{7,8}\-[0-9]{3,5}$)|(^[0-9]{7,8}\-[0-9]{3,5}$)|(^\([0-9]{3,4}\)[0-9]{7,8}$)|(^\([0-9]{3,4}\)[0-9]{7,8}\-[0-9]{3,5}$)|(^0{0,1}1[3|5|8|4|7][0-9]{9}$)/;
		...
		/*** check tel(非必填项)***********************/ 	
		jQuery.validator.addMethod("isTelNoRequire", function(value, element,param) {
			if(value.length == 0 ){
				return true;
			}
			var valArray = value.split(',');
