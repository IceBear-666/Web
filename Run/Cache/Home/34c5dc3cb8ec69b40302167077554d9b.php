...
<?php function deep_in_array($value, $array) { foreach($array as $item) { if(!is_array($item)) { if ($item == $value) { return true; } else { continue; } } if(in_array($value, $item)) { return true; } else if(deep_in_array($value, $item)) { return true; } } return false; } ?>
    ...
    <div class="section-top">
        <div class="section-top-contrainer">
            ...
            <div class="pull-right">
                <ul class="top-cat">
                   <li><a class="lt-title current" href="<?php echo U('Company/companylist');?>">实习</a> 
                   </li>
                    <li>|</li>
                    <li><a class="rt-title " href="<?php echo U('Company/fulltimecompanylist');?>">全职</a></li>
                </ul>
      ...
      <div class="tabs">
            ...
            <div class="content-wrap jm_companylist_r">
                ...
                <table class="jm_companylist_tb">
                    ...
                    <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i; if($v["cid"] == 1): foreach ($collet_list as $cl){ if($cl['cid'] == $v['id']){ $collet = 1; $kid = $cl['kid']; break; }else{ $collet = 0; } }; ?>
                        <?php  $now = strtotime(date('y-m-d',time())); $end_date = strtotime($v['end_time']);?>
                            ...
                            <tr>
                                ...
                                <td width="220">已结束 (<?php echo (date("Y年m月",$end_date)); ?> 截止)</td>
                                <?php elseif ($v['end_time'] == "0000-00-00 00:00:00") : ?>
                                <td width="220">已开始</td>
                                <?php endif;?> 
                                <?php if($collet == 1): ?><td width="40"><div class="collected jd_col" cid='<?php echo ($v["id"]); ?>' kid=<?php echo $kid?>><i class="icon-resumebold icon-favourite"></i><span class="dn collection_jd">取消收藏</span><i class="dn collection_jd_trangle"></i></div></td>
                                 <?php elseif($collet == 0): ?>
                                 <td width="40"><div class="jobCollection jd_col" cid='<?php echo ($v["id"]); ?>'><i class="icon-resumebold icon-favourite"></i><span class="dn collection_jd">收藏</span><i class="dn collection_jd_trangle"></i></div></td><?php endif; ?>
                ...
                <table class="jm_companylist_tb">
                    ...
                    <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i; if($v["cid"] == 41): foreach ($collet_list as $cl){ if($cl['cid'] == $v['id']){ $collet = 1; $kid = $cl['kid']; break; }else{ $collet = 0; } }; ?>
                        <?php  $now = strtotime(date('y-m-d',time())); $end_date = strtotime($v['end_time']);?>
                ...
                <table class="jm_companylist_tb">
                    ...
                    <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i; if($v["cid"] == 40): foreach ($collet_list as $cl){ if($cl['cid'] == $v['id']){ $collet = 1; $kid = $cl['kid']; break; }else{ $collet = 0; } }; ?>
                        <?php  $now = strtotime(date('y-m-d',time())); $end_date = strtotime($v['end_time']);?>
                ...
                <table class="jm_companylist_tb">
                    ...
                    <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i; if($v["cid"] == 63): foreach ($collet_list as $cl){ if($cl['cid'] == $v['id']){ $collet = 1; $kid = $cl['kid']; break; }else{ $collet = 0; } }; ?>
                        <?php  $now = strtotime(date('y-m-d',time())); $end_date = strtotime($v['end_time']);?>
                ...
                <table class="jm_companylist_tb">
                    ...
                    <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i; if($v["cid"] == 42): foreach ($collet_list as $cl){ if($cl['cid'] == $v['id']){ $collet = 1; $kid = $cl['kid']; break; }else{ $collet = 0; } }; ?>
                        <?php  $now = strtotime(date('y-m-d',time())); $end_date = strtotime($v['end_time']);?>
                ...
                <table class="jm_companylist_tb">
                    ...
                    <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i; if($v["cid"] == 203): foreach ($collet_list as $cl){ if($cl['cid'] == $v['id']){ $collet = 1; $kid = $cl['kid']; break; }else{ $collet = 0; } }; ?>
                        <?php  $now = strtotime(date('y-m-d',time())); $end_date = strtotime($v['end_time']);?>
