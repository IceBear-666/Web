         ...
         <div class="stform" id="have_com">
              ...
              <div class="step3">
                <h2 class="f16">根据你填写的公司邮箱（<a href="/User/register/del/1">返回修改邮箱地址</a>），请选择你要招聘的公司名称：</h2>
                 <div>
                   <u class="lf" href="javascript:void(0);"><?php echo ($same_company["company_name"]); ?></u>
           ...
           <div class="stform" id="no_com">
            <form  class="registerform" action="/Company/openZhaopin/" method="post">
             <li>
              ...
              <input style="width:430px;" class="myipt" type="text" name="company_name" id="company_name" value="<?php echo ($same_company["company_name"]); ?>" datatype="*4-20" placeholder="请输入公司名称并确保与公司执照一致，一经填写无法修改" nullmsg="请输入公司名称" errormsg="请输入4-20个字以内"/> 
             </li>
