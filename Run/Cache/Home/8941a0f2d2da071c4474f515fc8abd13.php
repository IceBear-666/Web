    ...
    <div style="width:700px; margin:0 auto;">
      <dl class="job_detail">
        ...
        <dt class="clearfix join_tc_icon">
          <h1 title="<?php echo ($info["positionName"]); ?>"><?php echo ($info["positionName"]); ?></h1>
        </dt>
         
         
        <dd class="job_request"> 
         <span>地点&nbsp;<?php echo ($info["workAddress"]); ?> <?php echo ($info["positionAddress"]); ?></span> <span>起薪&nbsp;<?php echo ($info["salaryMin"]); ?>k-<?php echo ($info["salaryMax"]); ?>k</span> <span>经验&nbsp;<?php echo ($info["workYear"]); ?> </span> <span> 学历&nbsp;<?php echo ($info["education"]); ?></span> <span>性质&nbsp;<?php echo ($info["jobNature"]); ?></span><br />
          职位诱惑 : <?php echo ($info["positionAdvantage"]); ?>
          <div class="f14 mt10">发布时间：刚刚</div>
        </dd>
        <dd class="job_bt">
          <h3 class="description">职位描述</h3>
          <!-- <p><strong>岗位职责：</strong></p> -->
          <?php echo ($info["positionDetail"]); ?>
        </dd>
