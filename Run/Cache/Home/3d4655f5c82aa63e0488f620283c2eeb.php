    ...
    <div class="clearfixs mr_created container" id="tab1">
		<section>
			<div class="tabs tabs-style-underline">
				<nav>
					<ul>
						<li><a href="#su1" class="icon icon-home"><span>基本信息</span></a></li>
						<li><a href="#section-underline-2" class="icon icon-gift"><span>教育信息</span></a></li>
						<li><a href="#section-underline-3" class="icon icon-upload"><span>工作经历</span></a></li>
						<li><a href="#section-underline-4" class="icon icon-coffee"><span>项目经历</span></a></li>
						<li><a href="#section-underline-5" class="icon icon-config"><span>在校实践</span></a></li>
						<li><a href="#section-underline-6" class="icon icon-config"><span>社团经历</span></a></li>
                        <li><a href="#section-underline-7" class="icon icon-config"><span>获奖经历</span></a></li>
                        <li><a href="#section-underline-8" class="icon icon-config"><span>语言能力</span></a></li>
                        <li><a href="#section-underline-9" class="icon icon-config"><span>证书</span></a></li>
                         <li><a href="#section-underline-10" class="icon icon-config"><span>培训经历</span></a></li>
                         <li><a href="#section-underline-11" class="icon icon-config"><span>其他信息</span></a></li>
					</ul>
				</nav>
                    ...
                    <td >
                     ...
                     <div class="form-item">
                      ...
                      <div class="controls select_wrap">
                        <select name="nativeplace"  id="provincelist" onchange="setcity(this)">
                          <option value="0">--选择省--</option>
                        
                        </select>
                        &nbsp;&nbsp;
                        <select name="nativeplace_city"   id="citylist">
...
<div  class="list_show">
   ...
   <div  class="list_show">
    ...
    <script type="text/javascript" src="/Public/Home/js/singletest.js"></script> 
    <!------------------------------------- end ----------------------------------------->
