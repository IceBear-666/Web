...
<script type='text/javascript'>
       ...
       // var constellation = "<?php echo ($user["constellation"]); ?>";
		...
		//var keepUrl = '<?php echo U("Collectonlineapp/index");?>';
    var URL='<?php echo U("Company/keep");?>';

   // var keeppUrl='<?php echo U("keep/keep");?>';
...
<script src="/Public/Home/js/qikoo.js"></script>
<div id="body"> 
              ...
              <div class="content-wrap">
                ...
                <section id="su1">
                  <div id="cbp-vm" class="cbp-vm-switcher cbp-vm-view-grid">
					...
					<?php if(!empty($arr)): ?><form action = "/Home/Message/send" method="post">
                  ...
                  <ul>
				     ...
				     <?php if(is_array($arr)): foreach($arr as $key=>$vo): ?><li class="z_i">
                      <h3 class="cbp-vm-title"><?php echo ($vo["title"]); ?>
						 ...
						 <!--<a href="/Home/Message/delete/id/<?php echo ($v["id"]); ?>" onClick="return confirm('确定要删除该条数据吗？');">删除</a>
						 
                          <a class="icon-resume icon-ottrush" href="/Home/Message/delete/id/<?php echo ($vo["id"]); ?>"  onclick="return c();"  ></a>-->
						   <a class="icon-resume icon-ottrush" href="/Home/Message/delete/id/<?php echo ($vo["id"]); ?>" onClick="delcfm()"  ></a>
						  
                          <a class="icon-resume icon-otedit" href="/Home/Message/edit/id/<?php echo ($vo["id"]); ?>"   ></a>
                        </div>
                      </h3>
                ...
                <!--<div  class="ot_delete_pop dn">
                      <p class="text">确认删除</p>
                      <p class="text"><?php echo ($vo["title"]); ?></p>
                      <div style="margin-top: 10px;"> <span class="ot_del_cancel">取消</span><span class="ot_del_ok">确认</span> </div>
                </div>-->
