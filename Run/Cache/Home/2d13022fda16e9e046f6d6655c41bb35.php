...
<div class="tilhed">
   <a class="golevel" href="<?php if(getUsersSession('type')==1) echo '/user/';else echo'/'; ?>"></a>
...
<div class="mbbox2">
      ...
      <div class="infocom" style="position:relative;">
        ...
        <div class="clr"></div>
          ...
          <?php if($cuser_type){}elseif(!in_array($info['uid'],$cids)){ ?>
           	<div class="mbscpos mbcang1" title="添加收藏" onclick="return user_collection(<?php echo ($info["uid"]); ?>,1,2,1)"></div>
           <?php }else{ ?>
           	<div class="mbscpos mbcang2" title="取消收藏" onclick="return user_collection(<?php echo ($info["uid"]); ?>,0,2,1)"></div>
           <?php } ?>
 ...
 <table class="mbcmico" width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="30%"><div class="cominfo1"><i></i><?php echo ($info["company_city"]); ?></div></td>
    <td><div class="cominfo2"><i></i><?php echo ($info["hangye"]); ?></div></td>
  </tr>
  <tr>
    <td><div class="cominfo3"><i></i><?php echo ($gongsi_xingzhi[$info['gongsi_xingzhi']]); ?></div></td>
    <td><div class="cominfo4"><i></i><?php echo ($info["guimu"]); ?></div></td>
  </tr>
</table>
