...
<style type="text/css">
  ...
  ul.top_nav {margin:0; width: 500px;}
  ul.top_nav li{
  ...
  .icebear-y{
    background: url('/Public/Home/images/icebeer-yellow.png');
  }
  .icebear-p{
    background: url('/Public/Home/images/icebeer-purple.png');
  }
  .icebear-g{
    background: url('/Public/Home/images/icebeer-green.png');
  }
  .icebear-o{
    background: url('/Public/Home/images/icebeer-orange.png');
  }
  .header-p{
        border-bottom: 3px solid #9893c2;
  }
  .header-g{
        border-bottom: 3px solid #82b547;
  }
  .header-o{
...
<?php if($show_nav == 1): ?><div class="num_box">
	<div class="num" id="num_00">
      ...
      <div class="header">
        <div class="w960">
          <div class="logo"><a <?php echo ($cur_top_nav["plugin"]); ?> href="/index.html"><div id="top-logo" class="logo icebear-y" /></div></div>
          	...
          	<div class="login">
                <ul class="top-right">
                  ...
                  <?php if(getUsersSession('type')==0){ ?>
                    <li><?php $user = session('user_auth'); echo $user['nickname'];?></li>
    ...
    <div class="rw680">
        ...
        <div  class="jm_companylist_r" style="margin:0;position: relative;">
            ...
            <table class="jm_companylist_tb">
			 ...
			 <?php if(is_array($weibo)): $i = 0; $__LIST__ = $weibo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                  <td width="210"><img src="<?php echo ($v['path']); ?>" style="height:50px;width:56px;"/><?php echo ($v["company_name"]); ?></td>
                  <td width="210"><a target="_blank" href="<?php echo ($v["url_link"]); ?>"><?php echo ($v["link"]); ?></a></td>
                  <td width="220">(<?php echo (date("Y年m月",$end_date)); ?> 截止</td>
                  <td width="40"><div id="jobCollection" class="jd_col"><i class="icon-resumebold icon-favourite"></i><span class='dn' wid='<?php echo ($v["id"]); ?>' id="collection_jd">收藏<?php if($v["keep"]): ?>(<?php echo ($v["keep"]); ?>)<?php endif; ?></span><i class="dn collection_jd_trangle"></i></div></td>
