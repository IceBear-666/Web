...
<div class="yzbox">
    ...
    <?php if($type != 'success' ): ?><!-- 发送 -->  
      ...
      <div class="login_logo"> <a href="/"><img src="/Public/Home/images/fasongcg.png" /></a></div> 
       <div class="gomail">链接已发送，快去验证吧～<br/><a href="<?php echo ($email_link); ?>" target="_blank"><?php echo ($email); ?></a></div>
       ...
       <!--   <h2> 欢迎来找份工作！</h2>
         ...
         <div class="yzbtn"><a href="<?php echo ($email_link); ?>" target="_blank">登录邮箱验证</a></div>
         <div>
