        ...
        <section>
          <div class="tabs tabs-style-fillup">
            <div class="resumebg-left" id="resumebg-left">
              <nav>
                <ul>
                  <li><a href="/Home/Message/customize" class="icon-resume icon-otuser"><span>我的</span></a></li>
              ...
              <div class="content-wrap">
                ...
                <section id="su1">
                  <div id="cbp-vm" class="cbp-vm-switcher cbp-vm-view-grid">
					...
					<?php if(is_array($editdb)): foreach($editdb as $key=>$vo): ?><form action = "/Home/Message/doadd" method="post">
                      ...
                      <tr>
                          ...
                          <td>
							...
							<input type='hidden' name='id' value="<?php echo ($vo["id"]); ?>"/>
                                ...
                                <input type="text" id="ot_title" name="title" value="<?php echo ($vo["title"]); ?>" class="ed_name form-control" >
                            </div>
                          </td>
                      </tr>
                      <tr>
                          ...
                          <td class="tb_textarea">
                            <textarea class="resumetextarea form-control" id="ot_content" name="content"><?php echo ($vo["content"]); ?></textarea>   
                            </td>
                      </tr>
                      </table>
                       <div class="btn-group">
