    ...
    <div class="section-top">
        <div class="section-top-contrainer">
            ...
            <div class="pull-right">
                <ul class="top-cat">
                    <li><a class="lt-title " href="">实习</a> 
                   </li>
                    <li>|</li>
                    <li><a class="rt-title current" href="" >全职</a></li>
                </ul>
            ...
            <div class="jm_companylist_r" style="margin:0;position: relative;">
               ...
               <div id="section-5" class="jm_companylist_section jm_consumable">
                ...
                <table class="jm_companylist_tb">
                    <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i; if($v["cid"] == 42): $now = strtotime(date('y-m-d',time())); $end_date = strtotime($v['end_time']);?>
