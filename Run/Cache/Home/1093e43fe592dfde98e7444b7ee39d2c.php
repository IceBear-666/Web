...
<div class="mbbox">
  ...
  <div class="login_box">
    ...
    <form id="registerForm"  action="/User/register.html" method="post" name="forms">
...
<div id="dncom">   
    ...
    <div class="txtct pdt20">已有账号？<a class="sty colac"  href="<?php echo U('User/login');?>">立即登录</a></div>
