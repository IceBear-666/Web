...
<link rel="stylesheet" type="text/css"  href="/Public/Home/mcss/reg.css" />
  ...
  <div class="mbbox">
     ...
     <div class="login_box"> 
      <form id="loginForm"  action="/User/login_iframe.html" method="post">
        
         <div class="loginForm">
         <input type="text" id="email" name="email" value="" tabindex="1" placeholder="请输入登录邮箱地址" /> 
         <!-- <input type="text" id="email" name="email" autocomplete="off" value="" tabindex="1" placeholder="请输入登录邮箱地址" />  -->
       ...
       <input type="hidden" id="timestamp" name="timestamp" value="" /> 
         ...
         <div class="txtct pdt20">没有账号？<a class="sty colac"  href="<?php echo U('User/register_iframe');?>">立即注册</a>
          &nbsp;<a href="/User/findPassword.html" target="_blank" class="sty colac" >忘记密码？</a> 
         <!-- <a href="/User/findPassword_iframe" class="sty colac" >忘记密码？</a> 
          -->
         </div>
