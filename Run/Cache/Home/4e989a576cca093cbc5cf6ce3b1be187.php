    ...
    <div class="rw680">
        ...
        <div  class="jm_companylist_r" style="margin:0;position: relative;">
            ...
            <table class="jm_companylist_tb">
              <tr>
                  <td width="210"><img src="/Public/Home/images/qq.png">腾讯</td>
                  <td width="210"><a target="_blank" href="">123123123</a></td>
                  <td width="220">已开始</td>
               ...
               <tr>
                  ...
                  <td width="210"><a target="_blank" href="">123123123</a></td>
                  <td width="220">已开始</td>
                  <td width="40"><div id="jobCollection" class="jd_col collected"><i class="icon-resumebold icon-favourite"></i><span class="dn" id="collection_jd">收藏</span><i class="dn collection_jd_trangle"></i></div></td>
              </tr>
            </table>
            </div>
        </div>
