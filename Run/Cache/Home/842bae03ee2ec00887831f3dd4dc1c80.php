...
<div class="login_wrapper">
  ...
  <input type="hidden" id="resubmitToken" value=""/>
  <div class="login_box">
    <form id="registerForm" class="loginForm" action="<?php echo U('User/register');?>" method="post" name="forms">
    ...
    <a class="btn-phone" href="<?php echo U('User/registerphone');?>"><i class="icon-user design_phone"></i>用手机号注册</a>
