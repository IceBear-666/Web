  ...
  <div class="w760 mt40">
   <div class="about">
     ...
     <h2>帮助中心</h2>
      ...
      <div class="cnt">
       <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div><a href="/News/info/id/<?php echo ($v["nid"]); ?>"><?php echo ($v["title"]); ?></a></div><?php endforeach; endif; else: echo "" ;endif; ?>
     </div>
