      ...
      <div class="header">
        <div class="w960">
          ...
          <?php else: ?>
	          ...
	          <div class="nav"><!-- <a <?php echo ($cur_top_nav["job"]); ?> href="/Jobs/index.html">职位</a><a <?php echo ($cur_top_nav["company"]); ?> href="/Company/index.html">公司</a><a <?php echo ($cur_top_nav["video"]); ?> href="/Video/index.html">宣讲会</a><a <?php echo ($cur_top_nav["post"]); ?> href="/Company/createPost.html">发布职位</a> -->
              <a href="/Plugin/plugin.html">功能介绍</a>
              <a href="/Plugin/install.html">安装教程</a>
              <a href="/News/about.html">关于我们</a>
            </div>
	          <div class="login">
