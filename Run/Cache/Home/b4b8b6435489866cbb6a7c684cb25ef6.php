      ...
      <div class="fjlist">
        ...
        <?php foreach($otherResume as $k=>$v){ ?>
          ...
          <li>
            ...
            <div id="mydel" class="down rt"><a class="xiazai" href="/Resume/downResume/id/<?php echo ($v["oid"]); ?>">下载</a><a dit="<?php echo ($v["oid"]); ?>" class="shanchu" href="javascript:">删除</a></div>
             <div class="clr"></div> 
          </li>
...
<!-- 板块右侧 -->    
    <div class="mr_myresume_r">
      <div class="jllfnav">
        ...
        <a class="nav2 cur2" href="/Resume/otherResume.html">附件简历<em><?php echo ($resumeCount); ?></em></a>
        <a class="nav3" href="/User/delivery.html">投递管理</a>
      </div>
      <div class="clr"></div>
       <div class="mr_upload mt20" <?php if($otherResume)echo 'dn'; ?>  ><a class="inline" href="#uploadFile" title="上传附件简历">上传附件简历</a> </div>
