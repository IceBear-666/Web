        ...
        <div id="mr_mr_head">
          ...
          <div class="mr_baseinfo">
            ...
            <div class="mr_p_info mr_infoed mr_w604 clearfixs <?php if(!$info['realname']){echo 'dn';} ?>">
              ...
              <div class="info_b"> <span class="dizhi"><i></i><em data-id="0" title="<?php echo ($info["city"]); ?>"><?php echo ($info["city"]); ?></em></span> <span class="mobile"><i></i><em title="<?php echo ($info["phone"]); ?>"><?php echo ($info["phone"]); ?></em></span> <span class="email"><i></i><em title="<?php echo ($info["email"]); ?>"><?php echo ($info["email"]); ?></em></span> 
              
          <span class="mr_edit mr_head_r mr_edit_on dn" data-birthday="<?php echo ($info["birthday"]); ?>"  data-sex='<?php if($info["sex"] == 2): ?>女<?php else: ?>男<?php endif; ?>' data-xl="<?php echo ($info["edu"]); ?>" data-gzjy="<?php echo ($info["workyear"]); ?>" data-city="<?php echo ($info["city"]); ?>" data-mobile="<?php echo ($info["phone"]); ?>" data-email="<?php echo ($info["email"]); ?>" data-realname="<?php echo ($info["realname"]); ?>"><i></i><em>编辑</em></span>  

             <form id="olinfoForm" class="info_t">
            ...
            <div class="mr_moudle_content mr_w604">
              ...
              <div class="list_show">
                ...
                <div class="mr_jobe_list">
                  ...
                  <div  class="<?php if(!$v['workContent']){echo 'dn';} ?> mr_content_m" ><?php echo ($v["workContent"]); ?></div>
                  <form class="jobExpForm" id="">
                      <input id="mr_expid" type="hidden" value="" />
                      <div class="mr_add_work">
                        <label>公司</label>
                        <div class="mr_input_div mr_click_flag">
                          <input class="mr_btn companyName"  name="companyName" value="<?php echo ($v["companyName"]); ?>" />
                        </div>
                        <label>职位</label>
                        <div class="mr_input_div mr_click_flag">
...
<!--      <li data-md="expectJob"  class="hide_md dn" >
  ...
  window.globals =  {
    ...
    <script type="text/javascript" src="/Public/Home/js/testnew_myresume.js"></script> 
    <!------------------------------------- end ----------------------------------------->
