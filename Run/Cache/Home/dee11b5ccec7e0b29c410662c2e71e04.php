        ...
        <div class="rw680">
            ...
            <div class="jm_companylist_r" style="margin:0;position: relative;">
                ...
                <table class="jm_companylist_tb">
                     <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i; if($v["cid"] == 41): $now = strtotime(date('y-m-d',time())); $end_date = strtotime($v['end_time']);?>
