...
<body>
    ...
    <div class="main-title">
        <h2><?php echo isset($info['id'])?'编辑':'新增';?>菜单</h2>
    </div>
    ...
    <form action="<?php echo U();?>" method="post" class="form-horizontal">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <label class="radio"><input type="radio" name="status" value="1" <?php if($info['status']!=0)echo 'checked'; ?> >启用</label>
                <label class="radio"><input type="radio" name="status" value="0" <?php if($info['status']==0)echo 'checked'; ?> >禁用</label>
            </div>
        </div>
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <select name="pid" id="pid">
                	...
                	<?php foreach($top_arr as $kk=>$vv){ ?>
                	<option value="<?php echo ($vv['id']); ?>" <?php if($info['pid']==$vv['id'])echo 'selected'; ?> ><?php echo ($vv['title']); ?></option>
                	<?php } ?>
                </select>
            </div>
        </div>
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <input type="text" class="text input-large" name="keyword" value="<?php echo ($info["keyword"]); ?>">
            </div>
        </div>
