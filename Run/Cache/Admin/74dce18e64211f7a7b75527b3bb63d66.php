...
<body>
    ...
    <div class="main-title">
        <h2><?php echo isset($info['aid'])?'编辑':'新增';?>地区</h2>
    </div>
    <form action="<?php echo U();?>" method="post" class="form-horizontal">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <select name="pid">
                    <?php if(is_array($Menus)): $i = 0; $__LIST__ = $Menus;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$menu): $mod = ($i % 2 );++$i;?><option value="<?php echo ($menu["aid"]); ?>"><?php echo ($menu["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
            </div>
        </div>
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <select name="acid" id="acid">
                	...
                	<?php foreach($ac_arr as $k=>$v){ ?>
                	<option value="<?php echo ($k); ?>" <?php if($k==$info['acid'])echo 'selected'; ?> ><?php echo ($v); ?></option>
                	<?php } ?>
                </select>
            </div>
        </div>
        ...
        <div class="form-item">
            <input type="hidden" name="aid" value="<?php echo ((isset($info["aid"]) && ($info["aid"] !== ""))?($info["aid"]):''); ?>">
    ...
    <script type="text/javascript">
        ...
        Think.setValue("ishot", <?php echo ((isset($info["ishot"]) && ($info["ishot"] !== ""))?($info["ishot"]): 0); ?>);
        //导航高亮
