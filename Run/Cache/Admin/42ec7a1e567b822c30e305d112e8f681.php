    ...
    <!--<div class="cf">
        ...
        <!--<div class="search-form fr cf">
            <div class="sleft">
                ...
                <a class="sch-btn" href="javascript:;" id="search" url="/Admin/Kaifang/index/p/1.html"><i class="btn-search"></i></a>
            </div>
        </div>
    </div>-->
    ...
    <div class="data-table table-striped">
        <form class="ids">
			...
			<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td>
                             <a href="/Admin/Kaifang/delete/id/<?php echo ($v["id"]); ?>" onclick = "return shifou();">删除</a>
                        </td>
