...
<body>
    ...
    <div class="cf">
        <a class="btn" href="<?php echo U('add',array('id'=>I('get.id',1)));?>">新 增</a>
       <!--  <button class="btn ajax-post confirm" url="<?php echo U('del');?>" target-form="ids">删 除</button> -->
        ...
        <div class="search-form fr cf">
            <div class="sleft">
                ...
                <a class="sch-btn" href="javascript:;" id="search" url="/Admin/Olapplication/index/p/1.html"><i class="btn-search"></i></a>
            </div>
        </div>
    </div>
        ...
        <form class="ids">
            <table>
                ...
                <?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
						...
						<td> <img src="<?php echo ($v['path']); ?>" style="height:50px;width:56px;"/></td>
