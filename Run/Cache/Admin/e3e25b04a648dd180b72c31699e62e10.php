...
<body>
    ...
    <div class="main-title">
        <h2><?php echo isset($info['sid'])?'编辑':'新增';?>学校</h2>
    </div>
    <form action="<?php echo U();?>" method="post" class="form-horizontal">
        ...
        <div class="form-item">
            <input type="hidden" name="sid" value="<?php echo ((isset($info["sid"]) && ($info["sid"] !== ""))?($info["sid"]):''); ?>">
    ...
    <script type="text/javascript">
        ...
        var cprovince = <?php echo ($info["pid"]); ?>;
        var ccity = <?php echo ($info["cid"]); ?>;
