...
<body>
    ...
    <div class="main-title">
        <h2><?php echo isset($info['aid'])?'编辑':'新增';?>广告</h2>
    </div>
    ...
    <form action="<?php echo U();?>" method="post" class="form-horizontal">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <select name="cid" id="cid">
                	...
                	<option value="<?php echo ($kk); ?>" <?php if($info['cid']==$kk)echo 'selected'; ?> ><?php echo ($vv); ?></option>
                	<?php } ?>
                </select>
            </div>
        </div>
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <input type="text" class="text input-small" name="sn" value="<?php echo ($info["sn"]); ?>">
            </div>
        </div>
