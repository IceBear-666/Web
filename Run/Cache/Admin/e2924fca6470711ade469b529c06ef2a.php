...
<body>
    ...
    <div class="cf">
        ...
        <div class="search-form fr cf">
            <div class="sleft">
                <input type="text" name="title" class="search-input" value="<?php echo I('title');?>" placeholder="请输入文章标题">
                <a class="sch-btn" href="javascript:;" id="search" url="/Admin/Collection/index/p/3.html"><i class="btn-search"></i></a>
            </div>
        </div>
    </div>
        ...
        <form class="ids">
            <table>
				...
				<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                        <td><input class="ids row-selected" type="checkbox" name="id[]" value="<?php echo ($v["nid"]); ?>"></td>                    
                        <td>  <?php echo ($v["company_name"]); ?> </td>
						 <td>  <?php echo ($v["link"]); ?> </td>
                       <td>  <?php echo (substr($v["start_time"],0,10)); ?></td>
                        <td>  <?php echo (substr($v["end_time"],0,10)); ?> </td>
                        <td>
                            <!--<a title="查看" href="/Admin/News/edit/id/<?php echo ($v["nid"]); ?>">编辑</a>-->
                            <a class="confirm ajax-get" title="删除" href="<?php echo U('del?id='.$v['nid']);?>">删除</a>
                        </td>
