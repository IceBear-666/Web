    ...
    <div class="cf">
        ...
        <div class="search-form fr cf">
            <div class="sleft">
                ...
                <a class="sch-btn" href="javascript:;" id="search" url="/Admin/Adv/index.html"><i class="btn-search"></i></a>
            </div>
        </div> -->
    </div>
        ...
        <form class="ids">
            <table>
				...
				<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                           ...
                           <td>  <img src="<?php echo ($v['path']); ?>" style="height:80px;width:100px;"/></td>
                        
                        <td>
                            <?php echo ($v["title"]); ?>
                        </td>
                        <td><?php echo (getadvtype($v["cid"])); ?></td>
                        <td><?php echo ($v["link"]); ?></td>
                        <td><?php echo ($v["sn"]); ?></td>
                        <td><?php echo (showdate($v["addtime"])); ?></td>
                        <td>
                            <a  href="/Admin/Adv/edit/id/<?php echo ($v["aid"]); ?>">编辑</a> &nbsp; &nbsp; 
