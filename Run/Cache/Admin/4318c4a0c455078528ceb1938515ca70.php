		...
		<div class="tab-content">
			<form action="<?php echo U();?>" method="post" class="form-horizontal">
				...
				<div id="tab1" class="tab-pane in tab1">
					...
					<div class="form-item">
						<label class="item-label">
							类型<span class="check-tips">（类型不能为空）</span>
						</label>
						<div class="controls">
							<label class="inline radio"><input type="radio" name="leixing" value="0" <?php if(!$info['leixing'])echo 'checked'; ?> >行业领域</label>
							<label class="inline radio"><input type="radio" name="leixing" value="1" <?php if($info['leixing'])echo 'checked'; ?>>职位类别</label>
						</div>
					</div>
					
					<div class="form-item">
						<label class="item-label">
							宣讲会显示<span class="check-tips"></span>
						</label>
						<div class="controls">
							<label class="inline radio"><input type="radio" name="video_show" value="0" <?php if(!$info['video_show'])echo 'checked'; ?> >否</label>
							<label class="inline radio"><input type="radio" name="video_show" value="1" <?php if($info['video_show'])echo 'checked'; ?>>是</label>
						</div>
					</div>
					...
					<div class="form-item">
						...
						<div class="controls">
							<input type="text" name="sort" class="text input-small" value="<?php echo ((isset($info["sort"]) && ($info["sort"] !== ""))?($info["sort"]):10); ?>">
						</div>
					</div>
