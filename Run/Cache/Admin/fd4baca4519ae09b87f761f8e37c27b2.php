...
<body>
	...
	<div class="tb-unit posr">
		<div class="tb-unit-bar">
			<a class="btn" href="<?php echo U('add');?>">新 增一级分类</a> &nbsp; 
			<!-- <button class="btn ajax-post confirm" url="<?php echo U('cache');?>" >缓存</button> -->
		...
		<div class="category">
			<div class="hd cf">
				...
				<div class="name" style="width:400px;text-align:center;">名称</div>
				<div class="order" style="width:200px;">英文标示</div>
				<div class="order" style="width:120px;">类型</div>
				<div class="order" style="width:100px;">宣讲会显示</div>
			</div>
