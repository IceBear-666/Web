...
<body>
    ...
    <div class="cf">
        ...
        <div class="search-form fr cf">
            <div class="sleft">
                <input type="text" name="title" class="search-input" value="<?php echo I('title');?>" placeholder="请输入模板名称">
                <a class="sch-btn" href="javascript:;" id="search" url="/Admin/Setting/emailTpl.html"><i class="btn-search"></i></a>
            </div>
        </div>
    </div>
        ...
        <form class="ids">
            <table>
				...
				<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><?php echo (showdate($v["update_time"])); ?></td>
                        
                        <td>
                            <a title="编辑" href="<?php echo U('editTpl?tid='.$v['tid']);?>">编辑</a>
                        </td>
