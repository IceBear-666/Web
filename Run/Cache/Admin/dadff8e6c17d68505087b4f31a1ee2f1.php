...
<body>
    ...
    <!-- <div class="cf">
        ...
        <div class="search-form fr cf">
            <div class="sleft">
                <input type="text" name="title" class="search-input" value="<?php echo I('title');?>" placeholder="请输入关键词">
                <a class="sch-btn" href="javascript:;" id="search" url="/Admin/Feedback/index.html"><i class="btn-search"></i></a>
            </div>
        </div>
    </div>-->
        ...
        <form class="ids">
            <table>
				...
				<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                        <!-- <td><input class="ids row-selected" type="checkbox" name="id[]" value="<?php echo ($v["fid"]); ?>"></td> -->
                        <td><?php echo ($v["fid"]); ?></td>
                        <td>
                        <?php if($v['uid']){ ?>
                        	<a  target="_bank" href="/User/index/uid/<?php echo ($v["uid"]); ?>"><?php if($v['realname'])echo $v['realname'];else echo $v['company_name']; ?></a>
                        <?php }else{ ?>
                        	<?php echo ($v["name"]); ?>
                        <?php } ?>
                        </td>                      
                        ...
                        <!-- <td><?php echo (getfeedbackstatus($v["status"])); ?></td> -->                        
                        <td><?php echo (msubstr($v["content"],0,100)); ?></td>
                        <td><?php echo (showdate($v["addtime"])); ?></td> 
                        <td>
                            <a title="查看" href="/Admin/Feedback/show/id/<?php echo ($v["fid"]); ?>">详情</a> 
                            <a class="confirm ajax-get" title="删除" href="<?php echo U('del?id='.$v['fid']);?>">删除</a>
                        </td>
