    ...
    <div class="cf">
        ...
        <div class="search-form fr cf">
            <div class="sleft">
                ...
                <a class="sch-btn" href="javascript:;" id="search" url="/Admin/Video/index.html"><i class="btn-search"></i></a>
            </div>
        </div>
    </div>
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th>所属公司</th>
                        <th>所属学校</th>
                        <th style="width:300px;word-break: break-all;">视频链接</th>
                        <th>日期</th>
                        <th>添加时间</th>
                        <th>操作</th>
                    </tr>
				...
				<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                        <!-- <td><input class="ids row-selected" type="checkbox" name="id[]" value="<?php echo ($v["vid"]); ?>"></td>
                         -->
                        <td>
                            <?php echo ($v["title"]); ?>
                        </td>
                        <td><?php echo (getstatus($v["status"])); ?></td>
                        <td><?php echo ($v["company_name"]); ?><!-- (<?php if($v['type'])echo '管理员';else echo $v['company_name']; ?>) --></td>
                        <td><?php echo (getschoolbyid($v["sid"])); ?></td>
                        <td><?php echo ($v["url"]); ?></td>
                        <td><?php echo ($v["date_ymd"]); ?> <?php echo ($v["date_time"]); ?></td>
                        <td><?php echo (showdate($v["addtime"],"Y-m-d")); ?></td>
                        <td>
                            <a title="编辑" href="<?php echo U('edit?id='.$v['vid']);?>">编辑</a>
                            <a class="confirm ajax-get" title="删除" href="<?php echo U('del?id='.$v['vid']);?>">删除</a>
                        </td>
