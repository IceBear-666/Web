...
<body>
    ...
    <form action="<?php echo U();?>" method="post" class="form-horizontal">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                ...
                <textarea name="content" style="height:400px;"><?php echo ($info["content"]); ?></textarea>
        ...
        <!-- <div class="form-item">
            <label class="item-label">关键词替换<span class="check-tips"> </span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="memo" value="<?php echo ((isset($info["memo"]) && ($info["memo"] !== ""))?($info["memo"]):''); ?>">
            </div>
        </div> -->

        <div class="form-item">
            <input type="hidden" name="tid" value="<?php echo ((isset($info["tid"]) && ($info["tid"] !== ""))?($info["tid"]):''); ?>">
    ...
    <script type="text/javascript">
        //Think.setValue("tid", <?php echo ((isset($info["tid"]) && ($info["tid"] !== ""))?($info["tid"]): 0); ?>);
