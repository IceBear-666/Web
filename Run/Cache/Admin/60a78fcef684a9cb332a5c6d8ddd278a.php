    ...
    <div class="cf">
        ...
        <div class="search-form fr cf">
            <div class="sleft">
                ...
                <a class="sch-btn" href="javascript:;" id="search" url="/Admin/Videoreview/index.html"><i class="btn-search"></i></a>
            </div>
        </div>-->
    </div>
        ...
        <form class="ids">
            <table>
				...
				<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><?php echo (getusernamebyuid($v["uid"],3)); ?></td>
                        <td><?php echo ($v["content"]); ?></td>
                        <td><?php echo (getcheckstatus($v["status"])); ?></td>
                        <td><?php echo (showdate($v["addtime"])); ?></td>
                        
                        <td>
                        	<?php if($v['status']==0){ ?>
                        		<a href="/Admin/Videoreview/checkStatus/id/<?php echo ($v["rid"]); ?>/type/1">审核通过</a> &nbsp; 
                        		<a href="/Admin/Videoreview/checkStatus/id/<?php echo ($v["rid"]); ?>/type/-1">不通过</a> &nbsp; 
                        	<?php } ?>
                            <!-- <a title="查看" href="/admin.php?s=/Videoreview/show/id/<?php echo ($v["rid"]); ?>">详情</a> &nbsp; --> 
                            <a class="confirm ajax-get" title="删除" href="<?php echo U('del?id='.$v['rid']);?>">删除</a>
                        </td>
