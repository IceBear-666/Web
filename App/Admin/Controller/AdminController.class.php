...
class AdminController extends Controller {
    ...
    protected function tuijianuser (  $model , $where = array() , $msg = array( 'success'=>'推荐成功！', 'error'=>'推荐失败！')){
    	$data    =  array('tj_index' => 1);
    	$this->editRow(   $model , $data, $where, $msg);
    }


    protected function tuijiancanceluser (  $model , $where = array() , $msg = array( 'success'=>'取消成功！', 'error'=>'取消失败！')){
    	$data    =  array('tj_index' => 0);
    	$this->editRow(   $model , $data, $where, $msg);
    }
    ...
    protected function restore (  $model , $where = array() , $msg = array( 'success'=>'状态还原成功！', 'error'=>'状态还原失败！')){
        $data    = array('user_status' => 1);
        $where   = array_merge(array('user_status' => -1),$where);
        $this->editRow(   $model , $data, $where, $msg);
    }
     ...
     * 返回数据集
     */
    protected function lists ($model,$where=array(),$order='',$base = array('user_status'=>array('egt',0)),$field=true){
        $options    =   array();
    ...
    //分页
    function _getPage($table,$map=array()){
        if(!$table){
            return array();
        }
        $REQUEST    =   (array)I('request.');
    ...
    //自定义分页
    function _getPage_new($total,$listRows=30){
